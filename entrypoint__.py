...
def main():
    ...
    df_grafik['Planned start time'] = pd.to_datetime(df_grafik['Planned start time'])
    df_grafik['Planned finish time'] = pd.to_datetime(df_grafik['Planned finish time'])
    df_grafik['Actual start time'] = pd.to_datetime(df_grafik['Actual start time'])
    df_grafik['Actual finish time'] = pd.to_datetime(df_grafik['Actual finish time'])
